...
| Q2. How many records have a word starting with the letter “w”?                      | Dhruv           | *" 1.	How	can	I	count	the	number	of	rows	in	pandas	where	the	text	column	contains	a	word	starting	with	the	letter	'w'? Explain	what	the	regex	pattern	\b[wW]\w*	means	and	why	it	is	used	to	detect	words	starting	with	'w'	or	'W'."*             |
